...
namespace SQLEngine.PostgreSql
{
    internal class CustomFunctionCallExpressionBuilder :AbstractQueryBuilder, ICustomFunctionCallNopBuilder, ICustomFunctionCallExpressionBuilder
    {
        ...
        internal CustomFunctionCallExpressionBuilder(Action<ISqlWriter> internalBuilder)
        {
            _internalBuilder = internalBuilder;
        }
        public static CustomFunctionCallExpressionBuilder Raw(Action<ISqlWriter> internalBuilder)
        {
            return new CustomFunctionCallExpressionBuilder(internalBuilder);
        }
