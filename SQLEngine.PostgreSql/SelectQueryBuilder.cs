...
{
    //internal enum PostgreSqlJoinTypes
    //{
    //    InnerJoin = 1,
    //    LeftJoin = 2,
    //    RightJoin = 3,
    ...
    //{
    //    private string ToString(PostgreSqlJoinTypes joinType)
    //    {
    //        switch (joinType)
    //        {
    //            case PostgreSqlJoinTypes.InnerJoin:
    //                return "INNER JOIN";
    //            case PostgreSqlJoinTypes.LeftJoin:
    //                return "LEFT JOIN";
    //            case PostgreSqlJoinTypes.RightJoin:
    //                return "RIGHT JOIN";
    //            default:
    ...
    //    public PostgreSqlJoinTypes JoinType { get; set; }
        ...
        IJoinedNeedsOnEqualsToQueryBuilder
    {
        ...
        //{
        //    _selectors.Add(new PostgreSqlColumn(columnName));
        //    return this;
        //}
        ...
        //{
        //    return OrderBy(new PostgreSqlColumn(columnName));
        //}
        //public ISelectOrderBuilder OrderByDesc(string columnName)
        //{
        //    return OrderByDesc(new PostgreSqlColumn(columnName));
        //}
        ...
        //{
        //    return GroupBy(new PostgreSqlColumn(columnName));
        //}
        ...
        //    _currentJoinModel.JoinType = PostgreSqlJoinTypes.InnerJoin;
        //    return this;
        //}
        ...
        //    _currentJoinModel.TableName = targetTableName;
        //    _currentJoinModel.TableAlias = targetTableAlias;
        //    _currentJoinModel.JoinType = PostgreSqlJoinTypes.RightJoin;
        //    return this;
        //}
        ...
        //    _currentJoinModel.TableName = targetTableName;
        //    _currentJoinModel.TableAlias = targetTableAlias;
        //    _currentJoinModel.JoinType = PostgreSqlJoinTypes.LeftJoin;
        //    return this;
        //}
        ...
        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderBy(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderBy(AbstractSqlColumn column)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderBy(string columnName)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderByDesc(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderByDesc(AbstractSqlColumn column)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderByDesc(string columnName)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderByDesc(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutWhereQueryBuilder.OrderBy(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderBy(AbstractSqlColumn column)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderByDesc(AbstractSqlColumn column)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderByDesc(string columnName)
        {
            throw new NotImplementedException();
        }

        ISelectOrderBuilder ISelectWithoutFromQueryBuilder.OrderBy(string columnName)
        {
            throw new NotImplementedException();
        }

        ISelectWithoutFromAndGroupQueryBuilder ISelectWithoutFromQueryBuilder.GroupBy(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectWithoutFromAndGroupQueryBuilder ISelectWithoutFromAndGroupQueryBuilder.GroupBy(AbstractSqlColumn expression)
        {
            throw new NotImplementedException();
        }
        ...
        ISelectWithoutFromAndGroupQueryBuilder ISelectWithoutFromAndGroupQueryBuilder.GroupBy(ISqlExpression expression)
        {
            throw new NotImplementedException();
        }

        ISelectWithoutFromAndGroupQueryBuilder ISelectWithoutFromQueryBuilder.GroupBy(AbstractSqlColumn column)
        {
            throw new NotImplementedException();
        }
