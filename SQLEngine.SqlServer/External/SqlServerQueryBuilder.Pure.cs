...
public partial class SqlServerQueryBuilder : IQueryBuilder
{
    ...
    [Pure]
    public AbstractSqlExpression SubString(ISqlExpression expression, AbstractSqlLiteral start,
        AbstractSqlLiteral length)
    {
        return RawInternal($"SUBSTRING({expression.ToSqlString()},{start.ToSqlString()},{length.ToSqlString()})");
    }
    ...
    [Pure]
    public AbstractSqlExpression SubString(AbstractSqlLiteral expression, AbstractSqlLiteral start,
        AbstractSqlLiteral length)
    {
        return RawInternal($"SUBSTRING({expression.ToSqlString()},{start.ToSqlString()},{length.ToSqlString()})");
    }
    ...
    [Pure]
    public AbstractSqlExpression SubString(AbstractSqlLiteral expression, ISqlExpression start,
        AbstractSqlLiteral length)
    {
        return RawInternal($"SUBSTRING({expression.ToSqlString()},{start.ToSqlString()},{length.ToSqlString()})");
    }
