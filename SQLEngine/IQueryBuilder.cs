...
namespace SQLEngine
{
    public interface IQueryBuilder:IDisposable
    {
        ...
        string DeclareRandom(string variableName, string type, string defaultValue = null);
        string Declare(string variableName, string type, string defaultValue = null);
        void SetToScopeIdentity(string variable);
        void Set(string variable, Func<IBinaryExpressionBuilder, IBinaryExpressionNopBuilder> right);
        void Set(string variable, string value);
        void Set(string variable, Func<ICastQueryBuilder, ICastQueryBuilder> q);
